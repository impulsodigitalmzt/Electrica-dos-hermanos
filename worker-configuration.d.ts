/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cec51b14619bca1b36972eef5828bf01)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	APP_NAME: "Eléctrica Dos Hermanos";
	SECRET_KEY: string;
	GROQ_API_KEY: string;
	WHATSAPP_TOKEN: string;
	VERIFY_TOKEN: string;
	INVENTARIO_SYNC_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "SECRET_KEY" | "GROQ_API_KEY" | "WHATSAPP_TOKEN" | "VERIFY_TOKEN" | "INVENTARIO_SYNC_KEY" | "GROQ_VISION_MODEL" | "GROQ_MODEL" | "GROQ_WHISPER_MODEL" | "WHATSAPP_APP_SECRET" | "DATABASE_URL">> {}
}
